...
Box.PlaceholderText = "Jogador alvo ðŸ¤¬"
Box.Text = ""
...
Label.Text = "script vip ðŸ’Ž | by dkzin ðŸ‡ªðŸ‡¬"
...
if not getgenv().Network then
	getgenv().Network = {
		BaseParts = {},
		Velocity = Vector3.new(100000000000000000000, 100000000000000000000, 100000000000000000000)
	}
...
local function JUBNQKI_fake_script() -- Button.Script 
	...
	script.Parent.MouseButton1Click:Connect(function()
		if player then
			...
			print("O jogador nÃ£o estÃ¡ selecionado")
		end
	end)
end
